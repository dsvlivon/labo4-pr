...
import { Auth, createUserWithEmailAndPassword, signInWithEmailAndPassword, signInWithPopup, signOut, GoogleAuthProvider, sendEmailVerification, User } from '@angular/fire/auth';
